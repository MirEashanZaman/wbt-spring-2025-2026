...
<title>Admin Dashboard &mdash; Car Showroom Management</title>
...
<main class="main-content">
    <div class="page-header">
        <div>
            <h1 class="page-title">Manage Salespersons</h1>
    ...
    <div class="card">
        <div class="card-toolbar">
            ...
            <span class="badge" id="resultCount"><?= count($salespersons) ?> total</span>
        </div>
            ...
            <table class="data-table">
                ...
                <tbody id="tableBody">
                    <?php if (empty($salespersons)): ?>
                        <tr><td colspan="5" class="empty">No salespersons yet.</td></tr>
                    <?php else: ?>
                        <?php foreach ($salespersons as $i => $salesperson): ?>
                            <tr>
                                <td><?= $i + 1 ?></td>
