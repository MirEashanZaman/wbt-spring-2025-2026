...
<title>Register &mdash; Car Showroom Management</title>
...
<div class="auth-shell">
    <div class="auth-side">
        <div class="logo-big">&#128663;</div> <!-- Car Icon -->
        <h1>Join as a Salesperson</h1>
        <p>Create your account to start managing cars in the showroom system.</p>
