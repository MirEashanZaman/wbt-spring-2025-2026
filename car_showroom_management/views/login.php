...
<title>Login &mdash; Car Showroom Management</title>
...
<div class="auth-shell">
    <div class="auth-side">
        ...
        <h1>Car Showroom System</h1>
        <p>Manage salespersons and cars in one place. Sign in to access your dashboard.</p>
        <ul class="feature-list">
            <li>&#10003; Admin manages salespersons</li>
            <li>&#10003; Salespersons manage cars</li>
